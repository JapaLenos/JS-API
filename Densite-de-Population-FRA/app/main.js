require([
  ...
  const popLayer7km = new FeatureLayer({
    url:
      "https://services.arcgis.com/d3voDfTFbHOCRwVR/arcgis/rest/services/fraPopDens_7km/FeatureServer",
    outFields: ["*"],
  ...
  let fraVilles10 = new FeatureLayer({
    url:
      "https://services.arcgis.com/d3voDfTFbHOCRwVR/ArcGIS/rest/services/villesFrance10/FeatureServer/3",
    outFields: ["*"],
    // This keeps the cylinders from poking above the ground
    elevationInfo: {
      mode: "relative-to-ground"
  ...
  var map = new Map({
    //basemap: "topo-vector",
    layers: [fraVilles10, popLayer7km],
    ground: {
